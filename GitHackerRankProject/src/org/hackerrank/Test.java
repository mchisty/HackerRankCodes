...
public class Test {
	...
	for (int i = 0; i < dimesion; ++i) {
		...
		int[] b = getAdjacentCellValues(aChar, i, j, dimesion, dimesion);
		if (null != b) {
		    aChar[i][j] = 'X';
		}
	    }
    ...
    // ------------------------------
    static int[] getAdjacentCellValues(final char[][] a, final int i, final int j, final int row, final int col) {
