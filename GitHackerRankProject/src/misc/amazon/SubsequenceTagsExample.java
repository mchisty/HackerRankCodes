...
//		st.subsequenceTags(targetList, availableList);
	...
	private List<Integer> subsequenceTags(List<String> targetList, List<String> availableList) {
		Map<String, Boolean> targetMap = new HashMap<String, Boolean>();
//		targetMap = targetList.stream().collect(Collectors.toMap(x -> x.toString(), Boolean.FALSE));
		for (String s : targetList) {
			targetMap.put(s, Boolean.FALSE);
		}
