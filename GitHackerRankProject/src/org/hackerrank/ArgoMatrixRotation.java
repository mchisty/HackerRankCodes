...
public class ArgoMatrixRotation {
	...
	// }
	// System.out.println("==============================================================");
	// numberOfRotations = mt.getActualNumberOfRotations(row, col,
	// numberOfRotations);
	...
	public static void main(String[] args) {
		...
		// -----------------------------------------------------------------------------------------------------
		// I discovered that if numberOfRotations >= fullRotation, the inner
		// alternating metrices should rotate twice
		// E.G. For a 6x8 Matrix, the following metrices should rotate this way,
		// - item starting at [0,0], [2,2], [4,4], [6,6] etc should rotate R
		// times
		// - item starting at [1,1], [3,3], [5,5], [7,7] etc should rotate R*2
		// times
		// -----------------------------------------------------------------------------------------------------
		// Update number of rotations and start positions
	...
	/**
	 * The idea here is to check if, after shifting cell one position, it
	 * matches with one of the list items. If so, then do the shifting;
	 * otherwise don't.
	 */
