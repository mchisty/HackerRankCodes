...
public class BitTest {
	...
	public static void main(String[] args) {
		...
		int num = 40;
		int divisor = 0x1F;
		System.out.println(num + " -> To binary: " + Integer.toBinaryString(num) + " -> To hex: "
				+ Integer.toHexString(num).toUpperCase());
		System.out.println(divisor + " -> To binary: " + Integer.toBinaryString(divisor) + " -> To hex: "
				+ Integer.toHexString(divisor).toUpperCase());
